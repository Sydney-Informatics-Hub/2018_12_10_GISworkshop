...
instructor: ["Darya Vanichkina", "Maryam Montazerolghaem"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
...
<p id="collaborative_notes">
  We will use this <a href="{{page.collaborative_notes}}">collaborative document</a> for chatting, taking notes, and sharing URLs and bits of code. Course material can be found <a href="https://datacarpentry.org/organization-geospatial/">here</a> and <a href="https://datacarpentry.org/r-raster-vector-geospatial/">here</a>.
</p>
{% endif %}
